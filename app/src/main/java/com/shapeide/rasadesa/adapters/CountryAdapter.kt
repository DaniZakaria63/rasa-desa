...
class CountryAdapter(val listener: (name: String) -> Unit) :
    ...
    private val arealist: ArrayList<com.shapeide.rasadesa.core.domain.Area> = ArrayList()
    ...
    fun updateAreaList(newItems : ArrayList<com.shapeide.rasadesa.core.domain.Area>){
    ...
    inner class Comparator(
        val oldValue: ArrayList<com.shapeide.rasadesa.core.domain.Area>,
        val newValue: ArrayList<com.shapeide.rasadesa.core.domain.Area>
    ) : DiffUtil.Callback() {
