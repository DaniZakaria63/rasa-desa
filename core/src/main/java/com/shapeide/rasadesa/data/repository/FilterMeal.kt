...
import com.shapeide.rasadesa.data.source.FilterMealDataSource
...
class FilterMeal @Inject constructor(
...
) : FilterMealDataSource {
    /* Make the data depends by category name */
    private val _filterMealData = MutableLiveData<List<com.shapeide.rasadesa.domain.FilterMeal>>()
    val filterMealData: LiveData<List<com.shapeide.rasadesa.domain.FilterMeal>> get() = _filterMealData
    ...
    override fun getFilterMealsLocal(mealName: String): List<com.shapeide.rasadesa.domain.FilterMeal> {
