...
import com.shapeide.rasadesa.data.source.CategoryDataSource
...
class CategoryRepository @Inject constructor(
    ...
    val _categoryData: LiveData<List<com.shapeide.rasadesa.domain.Category>> = desaDatabase.categoryDao.findAll().map {
        it.asDomainModel()
    }.asLiveData()
