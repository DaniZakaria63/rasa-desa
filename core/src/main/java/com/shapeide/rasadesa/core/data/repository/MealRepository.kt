...
import com.shapeide.rasadesa.core.data.source.MealDataSource
...
class MealRepository @Inject constructor(
...
) : com.shapeide.rasadesa.core.data.source.MealDataSource {

    val _favoriteData: LiveData<List<com.shapeide.rasadesa.core.domain.Meal>> = desaDatabase.mealDao.allFavorite().map {
        it.asDomainListModel()
    }.asLiveData()

    override suspend fun getRandomMeal(): com.shapeide.rasadesa.core.domain.Meal =
    ...
    override suspend fun getRandomMealLocal(): com.shapeide.rasadesa.core.domain.Meal =
        withContext(dispatcherProvider.io) {
            val data: MealEntity = desaDatabase.mealDao.findRandomOne()
            data.asDomainModel()
        }

    override suspend fun getMealByID(id: Int): com.shapeide.rasadesa.core.domain.Meal? = withContext(dispatcherProvider.io) {
        try {
    ...
    override fun getOneMealLocal(id: Int): com.shapeide.rasadesa.core.domain.Meal? { // already inside io dispatcher
